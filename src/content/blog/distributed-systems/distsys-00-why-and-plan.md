...
[커널](/blog/hobby/kernel-hobby-00-boot-to-paging)도, [DB](/blog/project/db-hobby/db-internals-01-storage)도, JVM도 밑바닥부터 만들어봤습니다. 그런데 전부 **컴퓨터 한 대 안**의 이야기더군요. 다음 축은 분명했습니다. 바로 **여러 대가 협력하는 분산 시스템**입니다.
