---
title: '범인 쿼리가 상위 목록에 안 잡힌다, MSSQL 장애 진단 순서'
description: "느려졌다는 신고 하나로 시작할 때 어디부터 보는가. 대기 통계는 인스턴스가 뜬 뒤로 누적된 값이라 지금을 못 보고, 블로킹 사슬의 뿌리는 sleeping 이라 실행 중인 것만 보는 도구에는 안 나오며, 계획 캐시를 총 논리 읽기로 정렬하면 부하의 절반이 순위에서 사라집니다."
date: 2026-08-09
tags:
  - SQL Server
  - MSSQL
