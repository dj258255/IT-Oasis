...
앞의 세 편은 전부 **무엇이 문제인지 아는 상태**에서 출발했습니다. 락 승격을 재려고
...
이 편은 앞의 세 편에서 임시로 짜 쓴 진단 쿼리들을 재사용 가능한 순서로 정리합니다.
...
이 시리즈는 여기서 닫습니다. 탐지(1편) · 락(2편) · 보정(3편) 은 전부 원인을 아는 상태에서 출발했고, 이 편이 그 앞에 붙는 자리입니다. 실제 순서는 진단이 먼저입니다.
