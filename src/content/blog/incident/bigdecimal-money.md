...
실험 네 개를 자바 한 파일([app/MoneyLab.java](https://github.com/dj258255/incident-lab/blob/main/sessions/F17-bigdecimal-money/app/MoneyLab.java))로 만들었습니다. 환경은 Docker 위 eclipse-temurin:21-jdk-alpine, JDK 21입니다. 무작위가 필요한 실험은 시드를 고정(실험 2는 42, 실험 3은 7)해서 `docker compose up` 한 번으로 누구나 같은 수치를 얻습니다.
...
![F17 재현 실행 화면](/uploads/incident/bigdecimal-money/01-buggy-run.png)

*그림 1. 재현 실행 화면입니다. double 누적은 0.0017원 모자라고, 절삭 지수는 30포인트 가까이 낮고, HALF_UP은 5만 원을 더 걷고, HashSet 중복 제거는 실패합니다.*

명령과 출력 원문은 [reproduce.md](https://github.com/dj258255/incident-lab/blob/main/sessions/F17-bigdecimal-money/reproduce.md)에 그대로 남겼습니다.
...
![F17 해소 재계측 실행 화면](/uploads/incident/bigdecimal-money/02-fixed-run.png)
...
![절삭 대 반올림 지수 오차](/uploads/incident/bigdecimal-money/03-index-error.png)
...
재현에 쓴 compose 파일과 실행 출력 원문은 [incident-lab 저장소의 F17 세션](https://github.com/dj258255/incident-lab/tree/main/sessions/F17-bigdecimal-money)에 있습니다.
