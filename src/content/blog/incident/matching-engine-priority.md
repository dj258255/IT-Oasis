...
- **매매체결원칙 넷 중 둘만 다뤘습니다.** 거래소의 원칙에는 위탁매매우선과 수량우선이 함께 있는데 이 글은 가격과 시간으로 좁혔습니다.
- **동시호가 예외를 재현하지 않았습니다.** 거래소 안내에 따르면 시가 등이 상·하한가로 결정되는 경우에만 예외적으로 인정되는데, 그 조건을 만들지 않았습니다.
