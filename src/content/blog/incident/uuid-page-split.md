...
디스크를 한 번도 때리지 않았고 UUIDv7 은 1,233번 때렸습니다. 테이블이 버퍼 풀보다 크고
...
순차 는 12,261 페이지 중 12,256 이 90~100% 한 칸에 몰려 있습니다. UUIDv4 은
**50~60% 구간에 4,588 페이지**가 쌓여 있고, 이것이 페이지 분할이 만든 반쯤 찬 페이지입니다.
분할은 꽉 찬 페이지를 둘로 쪼개므로 양쪽이 절반씩 남습니다. 그 흔적이 분포로 보입니다.

UUIDv7 이 양극화된 것은 이 실험의 밀리초당 20행 설정 때문입니다. 같은 밀리초 안에서는
