...
- **절대 시간은 인용할 수 없습니다.** 규모가 작고 Oracle과 SQL Server는 ARM 에뮬레이션입니다. 무엇이 규모를 타고 무엇이 안 타는지는 [13절](#13-mysql을-반복해서-그리고-규모를-키워서)에서 갈랐습니다.
- **파이프라인에 소유자가 없습니다.** 실패했을 때 누구를 깨우고 그 사람이 안 받으면 다음이 누구인지는 코드 밖의 문제입니다. [14절](#14-체크리스트를-파이프라인으로-옮겼습니다) 끝에서 다룹니다.
