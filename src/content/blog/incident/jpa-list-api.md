...
- **10절은 SQL로 직접 쟀습니다.** JPA 경로를 통과시키지는 않았습니다. 메커니즘이 DB 쪽이라 결과는 같겠지만 배치 크기와의 상호작용은 안 봤습니다.
...
- **대량 삽입에 워밍업이 없습니다.** 8절에서 회차를 넷으로 늘렸지만 회차마다 POST는 여전히 한 번이고, run0이 모든 조건에서 가장 느린 것도 그 때문일 수 있습니다. N+1과 페이지네이션처럼 워밍업 3회 뒤 5회 중앙값으로 바꾸지는 않았습니다. 함정 3의 소요 시간에는 관측 범위가 없습니다.
