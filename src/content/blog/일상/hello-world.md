...
사실 저는 뮤직플레이어 이런것도 다 제가 만들어서 사용하고 싶다는 욕망이 있어요..

네이버 블로그나 티스토리라는 선택지도 있었지만..

요즘 글로벌한 시대에 외국인들도 볼 수 있게 깃블로그로 만들었어요

그 증거로 헤더에 번역기능도 있지 않습니까?!

(제가 알기론 네이버 블로그나 티스토리는 이런게 제한적이죠!)

제가 영어 작문을 엄청 잘했다면 작문도 그대로 옮겨적었을텐데..

아쉽게도 그렇게 잘하지는 않는 편이라 AI를 이용해 그대로 옮길 것 같습니다 ㅋㅋㅋ

취업하고 나선 작문이랑 영어회화학원을 다녀서 전문적으로 공부해보고 싶어요

이 블로그는 **Astro**로 만들었어요
...
> 앞으로 개발하면서 배운 것들을 이곳에 기록할 예정이에요.
