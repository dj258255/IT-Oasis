...
![](/uploads/이론/jpa-persistence-context/transaction-basics.png)
...
![](/uploads/이론/jpa-persistence-context/proxy-pattern.png)
...
![](/uploads/이론/jpa-persistence-context/proxy-conceptual.png)
...
![](/uploads/이론/jpa-persistence-context/internal-call-trap.png)
...
![](/uploads/이론/jpa-persistence-context/readonly-declaration.png)
...
![](/uploads/이론/jpa-persistence-context/readonly-pattern.png)
...
![](/uploads/이론/jpa-persistence-context/version-optimistic-lock.png)

수정 시점에 version을 비교해서, 다른 트랜잭션이 먼저 수정했으면 `OptimisticLockException`을 던진다.

근데 `readOnly = true`에서 엔티티를 수정하면?

![](/uploads/이론/jpa-persistence-context/readonly-version-conflict.png)
...
![](/uploads/이론/jpa-persistence-context/physical-logical-transaction.png)
...
![](/uploads/이론/jpa-persistence-context/required-propagation.png)
...
![](/uploads/이론/jpa-persistence-context/requires-new-propagation.png)


![](/uploads/이론/jpa-persistence-context/requires-new-detail.png)
...
![](/uploads/이론/jpa-persistence-context/requires-new-usecase.png)
...
![](/uploads/이론/jpa-persistence-context/supports-propagation.png)
...
![](/uploads/이론/jpa-persistence-context/not-supported-propagation.png)
...
![](/uploads/이론/jpa-persistence-context/mandatory-propagation.png)
...
![](/uploads/이론/jpa-persistence-context/never-propagation.png)
...
![](/uploads/이론/jpa-persistence-context/rollback-rules.png)
...
![](/uploads/이론/jpa-persistence-context/rollback-checked-exception.png)
