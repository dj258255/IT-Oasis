...
리눅스·윈도우 커널이 실제로 쓰는 언어예요. [OSDev Wiki](https://wiki.osdev.org/Languages)도 지금까지 C를 1순위로 추천해요.
...
여기에 [Philipp Oppermann의 "Writing an OS in Rust"](https://os.phil-opp.com/) 2판이 **Windows·macOS·Linux에서 "Rust 외 의존성 0개"로 빌드**된다는 점이 쐐기를 박았어요. 전통적으로 OS 입문의 첫날 절반을 잡아먹던 "환경 세팅 지옥"을 통째로 없앤 거죠.
