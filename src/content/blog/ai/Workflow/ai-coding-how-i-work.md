...
![Before에서는 AI가 구현, 테스트, 완료 판단, "끝났습니다"까지 혼자 하고 다음 작업으로 간다. After에서는 AI는 구현만 하고, 스크립트가 결과 파일과 테스트 재실행을 다른 모델이 diff 검토를 맡아 막는다. 통과하면 다음 작업으로, 실패하면 되돌림·수정으로 간다](/uploads/blog/ai/ai-coding/request-vs-enforce.svg)
