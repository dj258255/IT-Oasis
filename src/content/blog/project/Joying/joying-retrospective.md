...
팀 6명 중 리드를 맡았고 백엔드 35%, 프론트엔드 10%를 담당했습니다. 회원 시스템과 실시간 채팅 시스템 전체를 설계하고 구현했습니다. 결제 에스크로는 담당자가 빠지면서 이어받았습니다.
...
마지막 주 하루 이틀 전인 11월 17~19일 사흘에만 298건, 전체의 29%가 몰려 있습니다. 결제 담당자의 마지막 커밋은 11월 14일 "결제-거래-에스크로 연동 완료"로 판매자(RENT) 쪽 플로우였습니다. 이후 11월 14~19일 제 커밋은 빌리는 사람(BORROW) 쪽 결제 플로우와 거래 생성 버그에 집중되어 있습니다. 담당자가 빠진 자리를 이어받아 완성한 시점이 마감 1주일 안쪽이었다는 뜻입니다.
