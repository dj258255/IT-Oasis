---
title: '발루노 프로젝트 소개: 게임 밸런스 수치를 스프레드시트로 관리하는 워크스페이스'
description: >-
  발루노는 캐릭터 스탯, 무기 수치, 성장 곡선처럼 표에 쌓이는 게임 기획 데이터를 스프레드시트로 편집하고
  버전별 변경 이력과 몬테카를로 시뮬레이션까지 한곳에서 관리하는 1인 개인 프로젝트입니다. 누구를 위한
  도구인지, 주요 기능과 구조, 실제로 저울질한 트레이드오프, 8개월 동안의 작업 기록까지 처음 보는 분도
  한 번에 이해할 수 있게 정리했습니다.
