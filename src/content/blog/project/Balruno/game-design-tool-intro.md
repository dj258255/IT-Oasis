...
description: 인디게임 개발자를 위한 웹 기반 게임 밸런스 데이터 관리 툴의 기능, 수식 체계, 시뮬레이션, 게임 엔진 연동을 소개합니다.
...
발루노는 인디게임 개발자를 위한 웹 기반 게임 밸런스 데이터 관리 툴입니다. 엑셀이나 구글 시트보다 게임 개발에 특화된 시트 시스템과 수식을 제공합니다.

---

## 문제 인식

게임 밸런싱 작업에는 반복적으로 필요한 것들이 있습니다.

- DAMAGE, SCALE, TTK 같은 게임 공식을 쉽게 적용할 수 있어야 합니다
- 캐릭터 스탯 변경 시 관련 데이터가 자동으로 재계산되어야 합니다
- 성장 곡선, 능력치 비교 등을 차트로 빠르게 확인할 수 있어야 합니다
- JSON, CSV 연동으로 게임 엔진에서 바로 쓸 수 있는 형태로 데이터를 추출할 수 있어야 합니다

기존 도구(엑셀, 구글 시트)로도 가능하지만, 게임 특화 함수가 없어서 매번 수식을 직접 작성하거나 VBA 스크립트를 유지보수해야 합니다.
