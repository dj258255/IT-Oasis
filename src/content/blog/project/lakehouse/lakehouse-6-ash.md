...
|---|---|---|
| 블로킹 에피소드 팩트 | 8.719초 | **1.008초** (8.6배) |
| 전체 | 20.34초 | **8.16초** (2.5배) |
...
| 계층 | 보존 | 답하는 질문 |
|---|---|---|
| 1초 원본 | 30일 | 초 단위 프레임 재구성 |
| 5분 롤업 | 영구 | 무엇을 기다렸나 |
| 블로킹 에피소드 | 영구 | 누가 누구를 막았나 |
