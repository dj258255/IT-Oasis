...
마지막으로 감지된 회귀에 AI 1차 분석을 붙였습니다. 그런데 당근 KDMS 발표에서 배운 게 있었습니다. 실행계획을 AI가 자동 분석하되, DB팀의 효율/비효율 판단 기준을 프롬프트에 명시해 둔다는 것이었습니다. 같은 입력에 같은 판정이 나와야 운영 도구로 신뢰할 수 있기 때문입니다.
