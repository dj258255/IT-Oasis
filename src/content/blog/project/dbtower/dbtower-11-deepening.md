...
백업 축은 5편(복원 검증)과 8편(신선도 감시)을 거치며 꽤 완성됐지만 VERIFICATION 29절에 정직하게 적어둔 구멍이 있었어요. **로컬 디스크에만 있는 백업은 서버가 죽으면 같이 죽습니다.** 3-2-1 원칙(사본 3, 매체 2, 오프사이트 1)의 마지막 1이 비어 있었던 것입니다.
