...
> 이게 이 도메인을 깊게 판 지점이에요. "충전 기능 만들었어요"가 아니라 **"전금법 기명 한도 200만원을 도메인 규칙으로 넣었고, 2024년 개정 전금법의 선불충전금 전액 별도관리도 원장 계정 분리로 반영할 수 있게 설계했어요"** — 규제를 코드로 옮겨보는 게 이 도메인 학습에서 제일 재밌는 부분이었어요.
