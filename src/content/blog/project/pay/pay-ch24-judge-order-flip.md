---
title: 'AI 심판에게 A/B 순서만 바꿔 물었더니 8번 모두 답이 뒤집혔다'
...
date: 2026-09-20
category: study/pay
coverImage: "/uploads/covers/project/pay/pay-ch24-judge-order-flip.svg"
draft: false
unlisted: true
series: "결제 시스템 만들기"
seriesOrder: 24
...
[받는 사람이 가드를 정하게 한 편](/blog/project/pay/pay-ch23-receiver-decides-guards)에서 운영자용 서술의 기본값을 켜지 못한 이유는 **사람이 고른 표본이 0건**이었기 때문입니다. 그래서 심판 모델로 1차 신호라도 만들어 보기로 했습니다.
...
- 앞 편(받는 사람이 가드를 정하게 한 기록): [같은 AI 출력인데 고객에게는 막고 운영자에게는 허용했다](/blog/project/pay/pay-ch23-receiver-decides-guards)
