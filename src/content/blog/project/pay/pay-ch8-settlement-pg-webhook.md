...
tags:
  ...
  - 결제 시스템
category: study/pay
coverImage: "/uploads/project/pay/thumbs/pay-ch8.svg"
draft: false
series: "결제 시스템 만들기"
seriesOrder: 8
---
...
무서운 대목은 따로 있다. 에스크로 홀드가 본질적으로 며칠짜리라, 이건 **거의 모든 항목이 타는 기본 경로**다. "구매확정 시점 정산"을 하겠다던 [바로 그 리워크](/blog/project/pay/pay-ch7-consume-align-harden)가 정작 지급을 막고 있었다.
