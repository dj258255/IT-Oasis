---
title: 'pay: 결제 실패를 정합하게 되돌리는 모듈형 모놀리스'
description: 'pay는 결제 승인부터 취소, 원장, 정산, 대사, 구독, 분쟁까지 처리하는 Spring Modulith 기반 결제 백엔드다. 어떤 기능이 있고 어디에서 어떤 선택을 했는지, 작업을 어떻게 쌓았는지를 다룬다.'
date: 2026-07-08
tags:
  - Payment
  - Spring Boot
...
- [결제 정합성을 운영 지표로 증명하는 법](/blog/project/pay/pay-ch25-payment-integrity-operations)
- [결제 재시도는 가용성을 높이는가, 장애를 증폭하는가](/blog/project/pay/pay-ch26-payment-retries-retry-storm)
- [대사 결과가 맞아도 확정하면 안 되는 경우](/blog/project/pay/pay-ch27-pending-posted-reconciliation)
- [결제 오케스트레이션은 장애를 줄이는가, 복잡성을 옮기는가](/blog/project/pay/pay-ch28-payment-orchestration-tradeoff)
- [결제 원장의 Hot Entity: 정합성을 지키면서 처리량을 얻는 법](/blog/project/pay/pay-ch29-ledger-hot-entity)
