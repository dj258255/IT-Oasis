...
모듈형 모놀리스를 골랐다. 1인 개인 프로젝트에서 MSA로 시작하면 서비스별 배포와 네트워크라는 인프라 복잡도가 정작 배우려던 도메인 설계를 덮어버린다. [Spring Modulith](/blog/project/pay/pay-ch1-payment-core) 위에서 패키지 하나가 모듈 하나이고, 모듈 사이는 직접 호출 대신 도메인 이벤트로만 잇는다.
