---
title: '동시성과 부하: 어디서 기다리게 할지 네 번 골랐다'
description: '재고를 동시에 깎는 세 방법을 실제 DB에서 재서 골랐고, 넘치는 요청은 문 앞에서 돌려보냈고, 데드락은 재시도해도 되는 실패로 분류했다. 그리고 그 유입 제어가 가려주던 적립 경합을 부하로 꺼내 승인 성공률을 39.6%에서 100%로 되돌렸다.'
