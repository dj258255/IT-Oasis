---
title: '부하테스트가 초록색이어도 아무것도 증명하지 못하는 이유'
description: '"제어를 켜니 p95가 14배 좋아졌다"는 실험은 계정 하나로 돌려 전역 층이 부하를 받은 적이 없었다. 검사가 스스로 성립을 말하게 만들었는데, 그 검사기가 하루에 두 번 헛통과했다.'
date: 2026-06-22
category: study/be-commerce
coverImage: "/uploads/project/be-commerce/thumbs/be-commerce-ch11.svg"
draft: true
series: "BE-commerce"
seriesOrder: 8
tags:
...
| "없다"는 서술 | `CAPTURED`: *"BE-commerce에 CAPTURED 같은 상태는 없다"* |
