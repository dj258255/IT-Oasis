---
title: '오락가락 프로젝트 소개: 목소리로 부를 노래를 추천하는 음성 분석 플랫폼'
description: >-
  오락가락은 사용자의 음성을 분석해 음역대와 음색에 맞는 노래를 추천하는 음성 기반 음악
  플랫폼입니다. 녹음을 모아 앨범도 만듭니다. SSAFY에서 6인 팀으로 5주 동안 만들었습니다.
  누구를 위한 서비스인지, 어떤 기능이 있는지, 어떻게 만들었는지, 5주 동안 일을 어떻게 나눠서
  했는지를 처음 보는 분이 한 번에 이해할 수 있게 정리했습니다.
date: 2025-10-01
tags:
  - Orakgarak
  - Team Project
