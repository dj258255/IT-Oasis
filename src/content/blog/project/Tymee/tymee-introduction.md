...
# 프로젝트 소개
이번에 사이드 프로젝트로 **타이미(Timey)**라는 앱을 개발하게 되었습니다. 기획부터 디자인, 개발까지 혼자서 진행하고 있는 1인 프로젝트입니다.
...
"청소년들이 공부보다 게임에 빠지는 이유는 피드백의 속도 차이에 있다."

게임은 버튼 하나만 눌러도 캐릭터가 움직이고, 점수가 오르고, 레벨업 효과음이 울립니다. 인풋을 넣는 순간 아웃풋이 바로 눈앞에 나타나죠. 반면 공부는 다릅니다. 오늘 3시간을 투자해도 당장 달라지는 건 없습니다. 성적이 오르려면 몇 주, 몇 달을 기다려야 하고, 그 사이에 동기는 자연스럽게 사라집니다.

결국 즉각적인 피드백의 부재가 공부를 지루하게 만드는 핵심 원인이었습니다.

# 여기에 한 가지를 더했습니다
사람들에게는 본능적으로 자신의 성취를 보여주고 싶은 욕구가 있습니다.

게임에서 랭킹 시스템이나 업적 배지가 효과적인 이유도 여기에 있죠. 단순히 잘하는 것에서 그치지 않고, 그걸 다른 사람에게 보여줄 수 있을 때 동기부여는 배가 됩니다. SNS에 운동 인증샷을 올리고, 독서 기록을 공유하는 것도 같은 맥락이라고 생각합니다.

# 그래서 타이미를 만들었습니다
이 두 가지 인사이트를 결합하면 어떨까 싶었습니다.

## 즉각적인 피드백
집중한 시간이 실시간으로 시각화되고, 바로바로 성취감을 느낄 수 있도록

## 성취 공유 욕구
내 집중 기록을 자랑하고, 다른 사람들과 비교하며 동기를 얻을 수 있도록
단순한 타이머 앱을 넘어서, 집중 자체를 게임처럼 재밌게 만드는 앱. 그게 타이미의 핵심 컨셉입니다.
