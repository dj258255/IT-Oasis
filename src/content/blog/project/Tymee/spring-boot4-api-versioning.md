...
Spring MVC의 설정을 커스터마이징할 수 있는 인터페이스입니다.
이 인터페이스를 구현하면 Spring MVC의 다양한 설정을 오버라이드할 수 있습니다.
...
Spring Boot 4.0에서는 `@RequestMapping`과 `@GetMapping` 등에 `version` 속성이 추가됐습니다.
