...
export default defineConfig({
  ...
  redirects: {
    ...
    // 정답이 하나로 정해지는 지식 정리·학습 기록은 내린다(엔지니어링 판단 기록만 남긴다).
    '/blog/theory/cache-and-buffer': `${base || ''}/blog`,
    '/blog/theory/db-index-01-explain-basics': `${base || ''}/blog`,
    '/blog/theory/db-index-02-scan-types': `${base || ''}/blog`,
    '/blog/theory/db-index-03-covering-index-ios': `${base || ''}/blog`,
    '/blog/theory/db-index-04-composite-leftmost': `${base || ''}/blog`,
    '/blog/theory/db-index-05-clustered-dbms': `${base || ''}/blog`,
    '/blog/theory/db-index-06-operations-limits': `${base || ''}/blog`,
    '/blog/theory/db-storage-01-heap-page-index': `${base || ''}/blog`,
    '/blog/theory/db-storage-02-row-vs-column': `${base || ''}/blog`,
    '/blog/theory/db-storage-03-hot-update-visibility-map': `${base || ''}/blog`,
    '/blog/theory/es-memory-01-jvm-heap': `${base || ''}/blog`,
    '/blog/theory/es-memory-02-gc': `${base || ''}/blog`,
    '/blog/theory/es-memory-03-off-heap': `${base || ''}/blog`,
    '/blog/theory/es-memory-04-page-cache': `${base || ''}/blog`,
    '/blog/theory/es-memory-05-elasticsearch': `${base || ''}/blog`,
    '/blog/theory/java-concurrency-collections': `${base || ''}/blog`,
    '/blog/theory/jpa-persistence-context': `${base || ''}/blog`,
    '/blog/theory/jvm-and-gc': `${base || ''}/blog`,
    '/blog/theory/lock-mechanisms-all': `${base || ''}/blog`,
    '/blog/theory/redis-caching-guide': `${base || ''}/blog`,
    '/blog/theory/semaphore-mutex-sync': `${base || ''}/blog`,
    '/blog/theory/spring-mvc-thread-pool': `${base || ''}/blog`,
    '/blog/theory/tomcat-nio-request-handling': `${base || ''}/blog`,
    '/blog/theory/transaction-acid-01-atomicity': `${base || ''}/blog`,
    '/blog/theory/transaction-acid-02-isolation': `${base || ''}/blog`,
    '/blog/theory/transaction-acid-03-consistency': `${base || ''}/blog`,
    '/blog/theory/transaction-acid-04-durability': `${base || ''}/blog`,
    '/blog/activity/aws-modern-app-training': `${base || ''}/blog`,
    '/blog/distributed-systems/distsys-00-why-and-plan': `${base || ''}/blog`,
    ...
    '/blog/project/pay/pay-ch2-payment-methods': `${base || ''}/blog/project/pay/pay-ch2-failure-design`,
    ...
    '/blog/project/pay/pay-2-designing-for-failure': `${base || ''}/blog/project/pay/pay-ch2-failure-design`,
    ...
    '/blog/project/pay/pay-9-multi-pg-routing': `${base || ''}/blog/project/pay/pay-ch2-failure-design`,
    ...
    '/blog/project/pay/pay-19-compensation-network-cancel': `${base || ''}/blog/project/pay/pay-ch2-failure-design`,
    ...
    '/blog/project/pay/pay-24-chaos-testing': `${base || ''}/blog/project/pay/pay-ch2-failure-design`,
    ...
    '/blog/project/pay/pay-46-multi-pg-routing': `${base || ''}/blog/project/pay/pay-ch2-failure-design`,
    ...
    '/blog/project/pay/pay-51-checkout-saga': `${base || ''}/blog/project/pay/pay-ch2-failure-design`,
