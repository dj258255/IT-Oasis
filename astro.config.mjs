...
export default defineConfig({
  ...
  redirects: {
    ...
    // 2026-09-20 DBTower 와 lakehouse 를 블로그에서 내렸다. 두 프로젝트의 옛 주소는
    // 프로젝트 목록으로 보낸다. (dbtower-1~10 은 그전에 이미 한 편으로 합쳐 둔 주소다.)
    '/blog/project/dbtower/dbtower-0-overview': `${base || ''}/projects`,
    '/blog/project/dbtower/dbtower-1-design': `${base || ''}/projects`,
    '/blog/project/dbtower/dbtower-2-engines-and-diagnosis': `${base || ''}/projects`,
    '/blog/project/dbtower/dbtower-3-production-safety': `${base || ''}/projects`,
    '/blog/project/dbtower/dbtower-4-deepening': `${base || ''}/projects`,
    '/blog/project/dbtower/dbtower-5-productionization': `${base || ''}/projects`,
    '/blog/project/dbtower/dbtower-6-backup': `${base || ''}/projects`,
    '/blog/project/dbtower/dbtower-7-multi-tenancy': `${base || ''}/projects`,
    '/blog/project/dbtower/dbtower-8-talking-and-lakehouse': `${base || ''}/projects`,
    '/blog/project/dbtower/dbtower-9-operational-bottlenecks': `${base || ''}/projects`,
    '/blog/project/dbtower/dbtower-10-ai-cost-audit': `${base || ''}/projects`,
